    ...
    <section ref={containerRef} className="py-40 px-6 w-full border-t border-neutral-200">
      <div className="container mx-auto max-w-5xl relative">
        ...
        <div className="text-center mb-24">
           ...
           <h2 className="font-display font-bold text-3xl sm:text-5xl md:text-7xl text-neutral-900 uppercase">
             Der Prozess
           </h2>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className={cn("w-full md:w-1/2 p-0", isEven ? "md:pl-20" : "md:pr-20 md:text-right")}>
        ...
        <h3 className="font-display font-bold text-3xl md:text-4xl text-neutral-900 mb-4">
          {step.title}
        </h3>
