    ...
    <main className="bg-white min-h-screen text-neutral-950 font-sans selection:bg-brand selection:text-neutral-950">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
             ...
             >
                <div className="mb-8 pb-8 border-b border-neutral-200">
                   ...
                   <h3 className="font-display font-bold text-3xl md:text-4xl text-neutral-400">Billig-Produktion</h3>
                </div>
             ...
             >
                ...
                <div className="mb-8 pb-8 border-b border-neutral-800 relative z-10">
                   ...
                   <h3 className="font-display font-bold text-3xl md:text-4xl text-white">Premium-Produktion</h3>
                </div>
      ...
      <section className="py-32 px-6 bg-neutral-950 text-white">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-20">
            <h2 className="font-display font-bold text-3xl sm:text-5xl md:text-6xl mb-6">
              WARUM ART.OF.MEDIA?
            </h2>
